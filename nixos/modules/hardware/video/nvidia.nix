  ...
  options = {
    ...
    hardware.nvidia.optimus_prime.enable = lib.mkOption {
      ...
      description = ''
        ...
        This results in the NVIDIA GPU being used for rendering while outputting to
        displays attached to the integrated Intel GPU.
    ...
    hardware.nvidia.optimus_prime.intelBusId = lib.mkOption {
      ...
      description = ''
        Bus ID of the NVIDIA GPU. You can find it using lspci; for example if lspci
        shows the NVIDIA GPU at "00:02.0", set this option to "PCI:0:2:0".
      '';
    };
  };
